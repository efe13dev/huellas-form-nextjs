...
export async function fetchAnimals(id?: string): Promise<AnimalType | AnimalType[]> {
...
export async function updateAnimal(id: string, updatedFields: Partial<AnimalType>): Promise<void> {
  const response = await fetch(`/api/adoption/`, {
    method: "PATCH",
    headers: {
